...
for episode in range(NUM_EPISODES):
    ...
    for i in range(200):
        ...
        if player.x == enemy.x and player.y == enemy.y:
            player_reward = -LOSE_PENALTY
            enemy_reward = WIN_REWARD
        elif player.x == food.x and player.y == food.y:
            #print("got food")
            player_reward = WIN_REWARD
            enemy_reward = -LOSE_PENALTY
        else:
        ...
        if player_reward == WIN_REWARD:
            new_player_q = WIN_REWARD
            new_enemy_q = -LOSE_PENALTY

        elif player_reward == -LOSE_PENALTY:
            new_player_q = -LOSE_PENALTY
            new_enemy_q = WIN_REWARD
        else:
        ...
        if show:
            ...
            if player_reward == WIN_REWARD or player_reward == -LOSE_PENALTY:
